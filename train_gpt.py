...
model: nn.Module = GPT(vocab_size=args.vocab_size, num_layers=12, num_heads=6, model_dim=768).cuda()
...
for step in range(train_steps + 1):
    ...
    if last_step or (args.val_loss_every > 0 and step % args.val_loss_every == 0):
        ...
        val_loader = distributed_data_generator(args.val_files, args.batch_size, args.seq_len, rank, world_size)
        val_loss = 0
        with torch.no_grad():
